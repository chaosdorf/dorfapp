...
public class ColorPickerDialog extends Dialog
{
	...
	public ColorPickerDialog(final Context context, final OnColorChangedListener listener, final String key, final int initialColor, final int defaultColor)
	{
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(new ColorPickerView(getContext(), l, initialColor, defaultColor));
